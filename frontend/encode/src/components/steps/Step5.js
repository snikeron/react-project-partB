...
export default class Step5 extends Component {
  ...
  isValidated() {
    ...
    const candidateData = {
      ...
      minSalary: "120000", // Number, 
      expectedJobTitle: ["Technology Companies", "Not For Profits", "Government"], // this.props.expectedJobTitle, 
      expectedRoleType: "Senior Developer, CTO, Devops", // this.props.expectedRoleType, 
